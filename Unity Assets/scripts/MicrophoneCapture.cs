...
public class MicrophoneCapture : MonoBehaviour
{
    ...
    **/
    const string PROJECT_ID = "drstats-covid-oauioo";
    const string email = "covidbeta@drstats-covid-oauioo.iam.gserviceaccount.com";
    /* Make sure it is in the Assets Folder so that this is only the name */
    string certPath = "drstats.p12";

    // This needs to be changed to access you script
    public AjBehaviourScript myScript;
    ...
    void Start()
    {
        ...
        this.myScript = GameObject.FindObjectOfType(typeof(AjBehaviourScript)) as AjBehaviourScript;
